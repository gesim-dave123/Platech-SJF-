...
namespace SJF_Simulation
{
    public partial class SplashScreen : Form
    {
        ...
        private void AnimatePanelGrowth(Panel panel, bool growWidth = true, int targetSize = 300, int speed = 5, bool growLeft = false)
        {
            new Thread(() =>
            {
        ...
        private void RunAfterDelay(int delayMilliseconds, Action action)
        {
            new Thread(() =>
            {
